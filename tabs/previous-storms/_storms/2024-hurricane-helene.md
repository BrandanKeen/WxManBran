...
thumbnail: /tabs/previous-storms/media/images/storms/2024-hurricane-helene/Helene_Landfall.jpg
overview: >-
...
<details class="storm-plot-group" open>
  ...
  <div id="helene-photos" class="media-wide"
    ...
    <div class="media-row two-up media-row--fill media-row--equal-height">
      <figure>
        <a
          href="{{ '/tabs/previous-storms/media/images/Helene_radar.GIF' | relative_url }}"
          target="_blank"
          rel="noopener noreferrer">
          <img
            src="{{ '/tabs/previous-storms/media/images/Helene_radar.GIF' | relative_url }}"
      ...
      <figure>
        <a
          href="{{ '/tabs/previous-storms/media/images/Helene_eye.png' | relative_url }}"
          target="_blank"
          rel="noopener noreferrer">
          <img
            src="{{ '/tabs/previous-storms/media/images/Helene_eye.png' | relative_url }}"
...
<div class="storm-data">
  <details class="storm-plot-group" open>
    ...
    <div class="storm-plot storm-multi-panels">
      <figure class="storm-multi-panels__figure">
        <a
          href="{{ '/tabs/previous-storms/media/images/multi-panels/Hurricane_Helene_MultiPanel.png' | relative_url }}"
          target="_blank" rel="noopener noreferrer">
          <img
            src="{{ '/tabs/previous-storms/media/images/multi-panels/Hurricane_Helene_MultiPanel.png' | relative_url }}"
  ...
  <details class="storm-plot-group" open>
    ...
    <div class="storm-plot">
      ...
      <iframe src="{{ '/tabs/data/datasets/2024-hurricane-helene/plots/Hurricane_Helene_MSLP.html' | relative_url }}?v={{ site.time | date: '%s' }}" width="100%" height="520" loading="lazy" style="border:0"></iframe>
    </div>
  </details>
  <details class="storm-plot-group">
    <summary class="storm-plot-summary">Pressure Tendencies</summary>
    <div class="storm-plot">
      <iframe src="{{ '/tabs/data/datasets/2024-hurricane-helene/plots/Hurricane_Helene_PTendency_5min.html' | relative_url }}?v={{ site.time | date: '%s' }}" width="100%" height="520" loading="lazy" style="border:0"></iframe>
    </div>
    <div class="storm-plot">
      <iframe src="{{ '/tabs/data/datasets/2024-hurricane-helene/plots/Hurricane_Helene_PTendency_10min.html' | relative_url }}?v={{ site.time | date: '%s' }}" width="100%" height="520" loading="lazy" style="border:0"></iframe>
    </div>
    <div class="storm-plot">
      <iframe src="{{ '/tabs/data/datasets/2024-hurricane-helene/plots/Hurricane_Helene_PTendency_15min.html' | relative_url }}?v={{ site.time | date: '%s' }}" width="100%" height="520" loading="lazy" style="border:0"></iframe>
    </div>
    <div class="storm-plot">
      <iframe src="{{ '/tabs/data/datasets/2024-hurricane-helene/plots/Hurricane_Helene_PTendency_30min.html' | relative_url }}?v={{ site.time | date: '%s' }}" width="100%" height="520" loading="lazy" style="border:0"></iframe>
    </div>
    <div class="storm-plot">
      <iframe src="{{ '/tabs/data/datasets/2024-hurricane-helene/plots/Hurricane_Helene_PTendency_1hour.html' | relative_url }}?v={{ site.time | date: '%s' }}" width="100%" height="520" loading="lazy" style="border:0"></iframe>
    </div>
  </details>
  <details class="storm-plot-group" open>
    ...
    <div class="storm-plot">
      ...
      <iframe src="{{ '/tabs/data/datasets/2024-hurricane-helene/plots/Hurricane_Helene_WindSpeed.html' | relative_url }}?v={{ site.time | date: '%s' }}" width="100%" height="520" loading="lazy" style="border:0"></iframe>
    </div>
  </details>
  <details class="storm-plot-group" open>
    ...
    <div class="storm-plot">
      ...
      <iframe src="{{ '/tabs/data/datasets/2024-hurricane-helene/plots/Hurricane_Helene_Temp_Dew.html' | relative_url }}?v={{ site.time | date: '%s' }}" width="100%" height="520" loading="lazy" style="border:0"></iframe>
    </div>
  </details>
  <details class="storm-plot-group" open>
    ...
    <div class="storm-plot">
      ...
      <iframe src="{{ '/tabs/data/datasets/2024-hurricane-helene/plots/Hurricane_Helene_RainRate.html' | relative_url }}?v={{ site.time | date: '%s' }}" width="100%" height="520" loading="lazy" style="border:0"></iframe>
    </div>
  </details>
</div>
<!-- DATA-SECTION:END -->
