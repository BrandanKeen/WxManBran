    ...
    <div class="development-list">
      <article class="development-item">
        ...
        <div class="development-media development-media--split">
          <figure class="development-media__figure">
            <a href="{{ '/tabs/about/media/Deplyable_Station2.JPEG' | relative_url }}" target="_blank" rel="noopener noreferrer">
              <img src="{{ '/tabs/about/media/Deplyable_Station2.JPEG' | relative_url }}" alt="Three portable weather station cases and tripods prepared for hurricane intercept missions">
            </a>
          </figure>
          <figure class="development-media__figure">
            <a href="{{ '/tabs/about/media/Deplyable_Station1.JPEG' | relative_url }}" target="_blank" rel="noopener noreferrer">
              <img src="{{ '/tabs/about/media/Deplyable_Station1.JPEG' | relative_url }}" alt="Deployable Davis Vantage Pro 2 weather station equipment staged on a workbench">
            </a>
          </figure>
        </div>
      ...
      <article class="development-item">
        ...
        <div class="development-media development-media--single">
          <figure class="development-media__figure">
            <a href="{{ '/tabs/about/media/new_station_mount.png' | relative_url }}" target="_blank" rel="noopener noreferrer">
              <img src="{{ '/tabs/about/media/new_station_mount.png' | relative_url }}" alt="Adjustable mast mounted to the WxManBran vehicle for elevating the anemometer">
            </a>
          </figure>
        </div>
