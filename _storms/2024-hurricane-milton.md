  ...
  <details class="storm-plot-group" open>
    ...
    <div class="storm-plot storm-multi-panels">
      <figure class="storm-multi-panels__figure">
        <img src="{{ '/assets/plots/2024-hurricane-milton/Hurricane_Milton_MultiPanel.svg' | relative_url }}" alt="Multi-panel plot for Hurricane Milton (Sarasota, FL)" loading="lazy">
      </figure>
    </div>
  </details>
