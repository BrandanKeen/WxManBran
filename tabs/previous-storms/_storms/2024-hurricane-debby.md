...
<details class="storm-plot-group" open>
  ...
  <div class="media-wide">
    <div class="media-row two-up media-row--fill media-row--center">
      <figure>
        <a href="{{ '/tabs/previous-storms/media/images/Debby_radar.gif' | relative_url }}" target="_blank" rel="noopener noreferrer">
          <img src="{{ '/tabs/previous-storms/media/images/Debby_radar.gif' | relative_url }}"
               alt="Hurricane Debby radar loop" loading="lazy" decoding="async">
        </a>
        <figcaption>Reflectivity of Hurricane Debby. Crosshairs show vehicle location.</figcaption>
      </figure>
    </div>
  </div>
</details>
