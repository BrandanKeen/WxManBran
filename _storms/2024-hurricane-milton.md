...
<div class="storm-page__image-pair">
  <figure class="storm-page__image">
    <img src="{{ '/assets/images/previous-storms/Milton_radar.GIF' | relative_url }}" alt="Radar imagery of Hurricane Milton">
  </figure>
  <figure class="storm-page__image">
    <img src="{{ '/assets/images/previous-storms/Milton_eye.png' | relative_url }}" alt="Eye of Hurricane Milton">
  </figure>
</div>
