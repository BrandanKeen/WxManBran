...
<details class="storm-plot-group" open>
  ...
  <div class="media-wide">
    <div class="media-row two-up media-row--fill media-row--center">
      <figure>
        <a href="{{ '/tabs/previous-storms/media/images/Hermine_radar.PNG' | relative_url }}" target="_blank" rel="noopener noreferrer">
          <img src="{{ '/tabs/previous-storms/media/images/Hermine_radar.PNG' | relative_url }}"
               alt="Hurricane Hermine radar loop" loading="lazy" decoding="async">
        </a>
        <figcaption>Reflectivity of Hurricane Hermine. Crosshairs show vehicle location.</figcaption>
      </figure>
    </div>
  </div>
</details>
