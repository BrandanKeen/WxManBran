...
<div class="storm-page__image-pair">
  <figure class="storm-page__image">
    <img src="{{ '/assets/images/previous-storms/Helene_radar.gif' | relative_url }}" alt="Radar imagery of Hurricane Helene">
  </figure>
  <figure class="storm-page__image">
    <img src="{{ '/assets/images/previous-storms/Helene_eye.png' | relative_url }}" alt="Eye of Hurricane Helene">
  </figure>
</div>
